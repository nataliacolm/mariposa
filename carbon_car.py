...
class CarbonCar(Carbon):
    ...
    def __init__(self):
        self.diesel_well_to_tank = (
            2.58 + 0.62
        )  # kg CO2/l #also considering emissions well-to-tank: https://www.nexxtlab.lu/co2-emissions-calculator/
    ...
    def calculate_co2(
        ...
        if fuel_type == "electric":
            ...
            kWh_per_100km = (
                int(electricity_consumption) / 0.83
            )  # We consider a grid-to-battery conversion efficiency of 83%: http://publications.lib.chalmers.se/records/fulltext/179113/local_179113.pdf
            ...
            print(
                "fuel_type value is not valid. It must be one of the following: ['electric', 'diesel', 'petrol']"
            )
        ...
        if int(pax_in_car) > 1:
            gr_co2_person = gr_co2_person // pax_in_car + (
                gr_co2_person % pax_in_car > 0
            )  # divide emissions of the car by number of passengers to get the footprint per person
